...
class RatioAndProportion extends StatefulWidget {
  const RatioAndProportion();

  @override
  _RatioAndProportionState createState() => _RatioAndProportionState();
}

class _RatioAndProportionState extends State<RatioAndProportion> {
  ...
  Future<void> fetchQuestionsAndAnswers() async {
    try {
      final response = await http.get(Uri.parse(
          'https://script.google.com/macros/s/AKfycbxwoa0PhSVPUGFF5sim5OcVX7tKlSGwpKThHKDsS0HFlevgDCgYLJF3YSbS-v20_TQ-/exec'));
