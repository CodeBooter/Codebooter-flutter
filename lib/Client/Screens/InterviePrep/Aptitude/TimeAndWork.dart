...
class TimeAndWork extends StatefulWidget {
  const TimeAndWork();

  @override
  _TimeAndWorkState createState() => _TimeAndWorkState();
}

class _TimeAndWorkState extends State<TimeAndWork> {
  ...
  Future<void> fetchQuestionsAndAnswers() async {
    try {
      final response = await http.get(Uri.parse(
          'https://script.google.com/macros/s/AKfycbzWPmeH4MwJSEOhPYHe9N1gKxCOFbsCwI4ZPlb3UpLJxPEysK47A721SC7swwzT0Rmu/exec'));
