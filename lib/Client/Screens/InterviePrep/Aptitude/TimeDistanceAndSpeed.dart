...
import 'package:provider/provider.dart';
import 'package:codebooter_study_app/AppState.dart';
class TimeDistanceAndSpeed extends StatefulWidget {
  const TimeDistanceAndSpeed();

  @override
  _TimeDistanceAndSpeedState createState() => _TimeDistanceAndSpeedState();
}

class _TimeDistanceAndSpeedState extends State<TimeDistanceAndSpeed> {
  ...
  Future<void> fetchQuestionsAndAnswers() async {
    try {
      final response = await http.get(Uri.parse(
          'https://script.google.com/macros/s/AKfycbz-iMv_TvbDJc5p2zVEJo9Jo1j1CTowgtCPYQASQI_uNXtiRc-fcJdJiqJwO6eerGKy/exec'));
