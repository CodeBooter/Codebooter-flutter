...
class OperatingSystem2 extends StatefulWidget {
  ...
  @override
  _OperatingSystem2State createState() => _OperatingSystem2State();
}

class _OperatingSystem2State extends State<OperatingSystem2> {
  ...
  Future<void> fetchQuestionsAndAnswers() async {
    try {
      final response = await http.get(Uri.parse(
          'https://script.google.com/macros/s/AKfycbyXZaAm0-D3qSxm_oR0aG-aNnkzDdVRhiCeLKlGI_ZlRRPfTdq_BgVNmBzkfrfb-92Z/exec'));
