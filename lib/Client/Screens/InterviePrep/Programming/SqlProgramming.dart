...
class SqlProgramming extends StatefulWidget {
  const SqlProgramming();

  @override
  _SqlProgrammingState createState() => _SqlProgrammingState();
}

class _SqlProgrammingState extends State<SqlProgramming> {
  ...
  Future<void> fetchQuestionsAndAnswers() async {
    try {
      final response = await http.get(Uri.parse(
          'https://script.google.com/macros/s/AKfycbzxN51auob5KIE4eAVmPCoPJ2wdH2IhY7OAHljxy-oqa5EpolgAj6NKsQA6YS3FCB6u/exec'));
