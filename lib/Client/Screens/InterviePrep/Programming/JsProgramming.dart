...
class JsProgramming extends StatefulWidget {
  const JsProgramming();

  @override
  _JsProgrammingState createState() => _JsProgrammingState();
}

class _JsProgrammingState extends State<JsProgramming> {
  ...
  Future<void> fetchQuestionsAndAnswers() async {
    try {
      final response = await http.get(Uri.parse(
          'https://script.google.com/macros/s/AKfycbwvQiRHv8SrEKadyUtnvr9uqarZcH27eIvUmwwi-fmqb2H4HXtNBKcZWSX_ok-TAy5K/exec'));
