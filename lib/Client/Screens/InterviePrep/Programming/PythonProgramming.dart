...
class PythonProgramming extends StatefulWidget {
  ...
  @override
  _PythonProgrammingState createState() => _PythonProgrammingState();
}
  ...
  Future<void> fetchQuestionsAndAnswers() async {
    try {
      final response = await http.get(Uri.parse(
          'https://script.google.com/macros/s/AKfycbxt-oxQ_bWxx3rKhnpESjcU8mpqODL-smx6phi3cDPB3KWnh4RaaF6hHor1cKk4wmDs/exec'));
