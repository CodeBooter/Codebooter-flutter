...
class BasicCivil extends StatefulWidget {
  ...
  @override
  _BasicCivilState createState() => _BasicCivilState();
}

class _BasicCivilState extends State<BasicCivil> {
  final String pdfUrl =
      'https://drive.google.com/uc?export=download&id=1NPKBCZlQ5cLqKZPwETs0RwNhcPwBJQL4'; // Replace 'YOUR_FILE_ID' with the actual file ID from Google Drive
  ...
  Future<void> downloadPdf() async {
    ...
    localPath = '${directory.path}/bcm.pdf';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Basic Civil & Mechanical Engineering Notes ',
          style: TextStyle(
              color: appState.isDarkMode ? Colors.white : Colors.black),
        ),
      ),
