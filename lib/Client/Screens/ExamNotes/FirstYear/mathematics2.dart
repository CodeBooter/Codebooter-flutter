...
class _Mathematics2State extends State<Mathematics2> {
  final String pdfUrl =
      'https://drive.google.com/uc?export=download&id=1ugUzg3I7vNenEEmjn_PIZFfAjdiX2-vc'; // Replace 'YOUR_FILE_ID' with the actual file ID from Google Drive
  ...
  Future<void> downloadPdf() async {
    ...
    localPath = '${directory.path}/mathematics2.pdf';
