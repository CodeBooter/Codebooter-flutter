...
class BasicMechanical extends StatefulWidget {
  const BasicMechanical({Key? key}) : super(key: key);

  @override
  _BasicMechanicalState createState() => _BasicMechanicalState();
}

class _BasicMechanicalState extends State<BasicMechanical> {
  final String pdfUrl =
      'https://ia902705.us.archive.org/28/items/bme-shivani-bt-203/BME%2C%20Shivani%20BT203.pdf';
  ...
  Future<void> downloadPdf() async {
    ...
    localPath = '${directory.path}/bme.pdf';
