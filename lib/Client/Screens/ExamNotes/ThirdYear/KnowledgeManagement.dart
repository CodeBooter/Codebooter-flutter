...
class KnowledgeManagement extends StatefulWidget {
  const KnowledgeManagement({Key? key}) : super(key: key);

  @override
  _KnowledgeManagementState createState() => _KnowledgeManagementState();
}

class _KnowledgeManagementState extends State<KnowledgeManagement> {
  final String pdfUrl =
      'https://ia601602.us.archive.org/15/items/project-management_202307/Project%20Management.pdf';
  ...
  Future<void> downloadPdf() async {
    ...
    localPath = '${directory.path}/km.pdf';
