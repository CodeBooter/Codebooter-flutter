...
class AdvanceArch extends StatefulWidget {
  const AdvanceArch({Key? key}) : super(key: key);

  @override
  _AdvanceArchState createState() => _AdvanceArchState();
}

class _AdvanceArchState extends State<AdvanceArch> {
  final String pdfUrl =
      'https://ia902604.us.archive.org/18/items/aca-shivani/ACA%20Shivani.pdf';
  ...
  Future<void> downloadPdf() async {
    ...
    localPath = '${directory.path}/advarch.pdf';
