...
class InternetWeb extends StatefulWidget {
  const InternetWeb({Key? key}) : super(key: key);

  @override
  _InternetWebState createState() => _InternetWebState();
}

class _InternetWebState extends State<InternetWeb> {
  final String pdfUrl =
      'https://drive.google.com/uc?export=download&id=1HY_YQCdSKQRw3aOQFnyTNC3cL8CYYrbf';
  ...
  Future<void> downloadPdf() async {
    ...
    localPath = '${directory.path}/iwt.pdf';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ' Internet and Web Technology Notes ',
          style: TextStyle(
            color: appState.isDarkMode ? Colors.white : Colors.black,
          ),
        ),
