...
class SoftwareArch extends StatefulWidget {
  const SoftwareArch({Key? key}) : super(key: key);

  @override
  _SoftwareArchState createState() => _SoftwareArchState();
}

class _SoftwareArchState extends State<SoftwareArch> {
  final String pdfUrl =
      'https://ia902601.us.archive.org/30/items/software-architecture-shivani/Software%20Architecture%20Shivani.pdf';
  ...
  Future<void> downloadPdf() async {
    ...
    localPath = '${directory.path}/sa.pdf';
