...
class CloudComputing extends StatefulWidget {
  ...
  @override
  _CloudComputingState createState() => _CloudComputingState();
}

class _CloudComputingState extends State<CloudComputing> {
  final String pdfUrl =
      'https://drive.google.com/uc?export=download&id=1p8CMfnhvsL9fc3C5ZVRLqtcyUgH2Xcrs';
  ...
  Future<void> downloadPdf() async {
    ...
    localPath = '${directory.path}/cc.pdf';
