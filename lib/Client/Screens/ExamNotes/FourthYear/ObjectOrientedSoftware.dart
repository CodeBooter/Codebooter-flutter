...
class ObjectOrientedSoftware extends StatefulWidget {
  const ObjectOrientedSoftware({Key? key}) : super(key: key);

  @override
  _ObjectOrientedSoftwareState createState() => _ObjectOrientedSoftwareState();
}

class _ObjectOrientedSoftwareState extends State<ObjectOrientedSoftware> {
  final String pdfUrl =
      'https://ia902704.us.archive.org/21/items/ooad-shivani/OOAD%20Shivani.pdf';
  ...
  Future<void> downloadPdf() async {
    ...
    localPath = '${directory.path}/oose.pdf';
