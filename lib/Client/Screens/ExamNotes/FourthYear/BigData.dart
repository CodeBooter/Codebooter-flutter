...
class BigData extends StatefulWidget {
  ...
  @override
  _BigDataState createState() => _BigDataState();
}

class _BigDataState extends State<BigData> {
  final String pdfUrl =
      'https://ia601600.us.archive.org/17/items/big-data-shivani/Big%20Data%20Shivani.pdf';
  ...
  Future<void> downloadPdf() async {
    ...
    localPath = '${directory.path}/bigdata.pdf';
