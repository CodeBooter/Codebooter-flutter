...
class DigitalSystems extends StatefulWidget {
  const DigitalSystems({Key? key}) : super(key: key);

  @override
  _DigitalSystemsState createState() => _DigitalSystemsState();
}

class _DigitalSystemsState extends State<DigitalSystems> {
  final String pdfUrl =
      'https://drive.google.com/uc?export=download&id=16NFOUzJXLay-UUNjiTEqNOMKhkJwY930';
  ...
  Future<void> downloadPdf() async {
    ...
    localPath = '${directory.path}/digitalsystems.pdf';
