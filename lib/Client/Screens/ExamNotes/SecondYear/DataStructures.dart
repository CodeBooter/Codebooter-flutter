...
class _DataStructureState extends State<DataStructure> {
  final String pdfUrl =
      'https://drive.google.com/uc?export=download&id=1oihazuLr_wSTynnet449wJwQWU8SkHYL'; // Replace 'YOUR_FILE_ID' with the actual file ID from Google Drive
  ...
  Future<void> downloadPdf() async {
    ...
    localPath = '${directory.path}/datastructure.pdf';
