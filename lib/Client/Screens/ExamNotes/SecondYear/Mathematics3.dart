...
class Mathematics3 extends StatefulWidget {
  const Mathematics3({Key? key}) : super(key: key);

  @override
  _Mathematics3State createState() => _Mathematics3State();
}

class _Mathematics3State extends State<Mathematics3> {
  final String pdfUrl =
      'https://drive.google.com/uc?export=download&id=1I6gKuVFuokb_GsCG-IEclCoCzSnIYXB4';
  ...
  Future<void> downloadPdf() async {
    ...
    localPath = '${directory.path}/mathematics3.pdf';
