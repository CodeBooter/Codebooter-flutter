...
class ObjectOriented extends StatefulWidget {
  ...
  @override
  _ObjectOrientedState createState() => _ObjectOrientedState();
}

class _ObjectOrientedState extends State<ObjectOriented> {
  final String pdfUrl =
      'https://drive.google.com/uc?export=download&id=1Rve0FY9cBI1acdmKNTaU18vmOQXU4jQV';
  ...
  Future<void> downloadPdf() async {
    ...
    localPath = '${directory.path}/oopm.pdf';
