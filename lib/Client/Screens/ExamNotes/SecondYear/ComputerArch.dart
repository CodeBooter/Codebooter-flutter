...
class ComputerArch extends StatefulWidget {
  const ComputerArch({Key? key}) : super(key: key);

  @override
  _ComputerArchState createState() => _ComputerArchState();
}

class _ComputerArchState extends State<ComputerArch> {
  final String pdfUrl =
      'https://drive.google.com/uc?export=download&id=14qEQY3ykkz0OaHEbBMPmsJAOY73vIpVP';
  ...
  Future<void> downloadPdf() async {
    ...
    localPath = '${directory.path}/coa.pdf';
