...
class DecentralizedApplication extends StatelessWidget {
  const DecentralizedApplication({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final appState = Provider.of<AppState>(context);
    const String playlistId = 'PLgPmWS2dQHW_8indakJ5MxKAKdVliIatp';
